...
impl Octopus {
    ...
    pub fn new(ctx: &Context) -> GameResult<Self> {
        let is_diver = false;
        let main = Data {
            image: Image::from_path(ctx, "/image/octopus/main.png")?,
            x: 545.0,
            y: 209.0,
        };
        let playing = false;
        ...
        let tentacles = [
            vec![
                Data {
                    image: Image::from_path(ctx, "/image/octopus/tentacles11.png")?,
                    x: 436.0,
                    y: 319.0,
                },
                Data {
                    image: Image::from_path(ctx, "/image/octopus/tentacles12.png")?,
                    x: 332.0,
                    y: 333.0,
                },
                Data {
                    image: Image::from_path(ctx, "/image/octopus/tentacles13.png")?,
                    x: 248.0,
                    y: 290.0,
                },
            ],
            vec![
                ...
                Data {
                    image: Image::from_path(ctx, "/image/octopus/tentacles22.png")?,
                    x: 383.0,
                    y: 379.0,
                },
                Data {
                    image: Image::from_path(ctx, "/image/octopus/tentacles23.png")?,
                    x: 349.0,
                    y: 428.0,
                },
                Data {
                    image: Image::from_path(ctx, "/image/octopus/tentacles24.png")?,
                    x: 296.0,
                    y: 491.0,
                },
            ],
            vec![
                Data {
                    image: Image::from_path(ctx, "/image/octopus/tentacles31.png")?,
                    x: 601.0,
                    y: 396.0,
                },
                Data {
                    image: Image::from_path(ctx, "/image/octopus/tentacles32.png")?,
                    x: 590.0,
                    y: 451.0,
                },
                Data {
                    image: Image::from_path(ctx, "/image/octopus/tentacles33.png")?,
                    x: 573.0,
                    y: 497.0,
                },
                Data {
                    image: Image::from_path(ctx, "/image/octopus/tentacles34.png")?,
                    x: 562.0,
                    y: 570.0,
                },
                Data {
                    image: Image::from_path(ctx, "/image/octopus/tentacles35.png")?,
                    x: 534.0,
                    y: 637.0,
                },
            ],
            vec![
                Data {
                    image: Image::from_path(ctx, "/image/octopus/tentacles41.png")?,
                    x: 750.0,
                    y: 484.0,
                },
                Data {
                    image: Image::from_path(ctx, "/image/octopus/tentacles42.png")?,
                    x: 751.0,
                    y: 533.0,
                },
                Data {
                    image: Image::from_path(ctx, "/image/octopus/tentacles43.png")?,
                    x: 769.0,
                    y: 589.0,
                },
                Data {
                    image: Image::from_path(ctx, "/image/octopus/tentacles44.png")?,
                    x: 761.0,
                    y: 662.0,
                },
            ],
            vec![
                Data {
                    image: Image::from_path(ctx, "/image/octopus/tentacles51.png")?,
                    x: 1028.0,
                    y: 557.0,
                },
                Data {
                    image: Image::from_path(ctx, "/image/octopus/tentacles52.png")?,
                    x: 1057.0,
                    y: 618.0,
                },
                Data {
                    image: Image::from_path(ctx, "/image/octopus/tentacles53.png")?,
                    x: 1093.0,
                    y: 680.0,
                },
            ],
            vec![
                ...
                Data {
                    image: Image::from_path(ctx, "/image/octopus/tentacles33a.png")?,
                    x: 628.0,
                    y: 500.0,
                },
            ],
