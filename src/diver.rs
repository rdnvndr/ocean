...
impl Diver {
    ...
    pub fn new(ctx: &Context) -> GameResult<Self> {
        ...
        let score = 0;
        let diver = [
            Data { image: Image::from_path(ctx, "/image/diver/diver1.png")?, x:  96.0, y:  28.0 },
            Data { image: Image::from_path(ctx, "/image/diver/diver2.png")?, x:  98.0, y: 260.0 },
            Data { image: Image::from_path(ctx, "/image/diver/diver3.png")?, x: 150.0, y: 515.0 },
            Data { image: Image::from_path(ctx, "/image/diver/diver4.png")?, x: 364.0, y: 672.0 },
            Data { image: Image::from_path(ctx, "/image/diver/diver5.png")?, x: 620.0, y: 680.0 },
            Data { image: Image::from_path(ctx, "/image/diver/diver6.png")?, x: 936.0, y: 699.0 },
            Data { image: Image::from_path(ctx, "/image/diver/diver7.png")?, x: 664.0, y: 400.0 },
        ];
        let bag = [
            Data { image: Image::from_path(ctx, "/image/diver/diver1_bag.png")?, x: 198.0, y: 137.0 },
            Data { image: Image::from_path(ctx, "/image/diver/diver2_bag.png")?, x: 260.0, y: 372.0 },
            Data { image: Image::from_path(ctx, "/image/diver/diver3_bag.png")?, x: 261.0, y: 669.0 },
            Data { image: Image::from_path(ctx, "/image/diver/diver4_bag.png")?, x: 508.0, y: 803.0 },
            Data { image: Image::from_path(ctx, "/image/diver/diver5_bag.png")?, x: 766.0, y: 798.0 },
            Data { image: Image::from_path(ctx, "/image/diver/diver6_bag.png")?, x: 875.0, y: 762.0 },
        ];
        let lifting_data = [
            AnimData{
                image: None,
        ...
        Ok(Self{
            pos, bag_value, score, diver, bag, lifting, filling, hand, move_sound, playing_sound })
    }
